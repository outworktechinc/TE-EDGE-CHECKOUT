 ...
 */
export function formatWithCode(amount, currency, locale = 'en-US') {
 ...
 */
export function compareAmounts(amount1, amount2, epsilon = 0.01) {
...
export function formatAmount(amount, currency, context = {}) {
