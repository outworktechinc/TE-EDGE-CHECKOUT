 ...
 */
export async function handleStripe3DS(paymentIntentClientSecret, stripe, _options = {}) {
    try {
 ...
 */
export async function handleBraintree3DS(nonce, amount, braintreeClient, _options = {}) {
    try {
        // Load 3DS module
 ...
 */
export async function handleAuthorizeNet3DS(transactionId, adapter, _options = {}) {
    try {
 ...
 */
export function is3DSRequired(amount, country) {
 ...
 */
export function getChallengeWindowSize() {
 ...
 */
export function format3DSError(result) {
