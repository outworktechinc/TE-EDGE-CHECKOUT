 ...
 */
import { getCardBrandName } from './card-validation';
/**
 ...
 */
export function getCardIcon(cardBrand) {
...
export function getGatewayIcon(gateway) {
    ...
    return GATEWAY_ICONS[lowerGateway] || '';
}
/**
 * Preload card icons
 ...
 */
export function createCardIconElement(cardBrand, options) {
    if (typeof window === 'undefined') {
        return null;
    }
    const img = new Image();
