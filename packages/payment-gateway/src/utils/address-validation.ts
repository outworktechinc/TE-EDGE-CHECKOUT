 ...
 */
export function formatZipCode(zip: string, country: string): string {
 ...
 */
export function getStateName(stateCode: string, country: string): string {
 ...
 */
export function formatAddressForDisplay(address: BillingAddress): string {
  const parts: string[] = [
    address.address,
    address.address2,
